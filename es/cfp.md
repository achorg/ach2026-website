...
Enfoque de la conferencia: Emergenc**ia/e/y**

ACH 2026 explora cómo en momentos de urgencia creamos y colaboramos en una conferencia virtual bilingüe. En inglés emergencia puede significar tanto *emergenc**e*** o *emergenc**y***. Este doble significado nos sirve de punto de partida. Mientras que emergencia/**e** se refiere al crecimiento, la conexión y la creación, emergencia/**y** señala momentos de urgencia que exigen atención, respuesta y transformación. ACH 2026 busca preguntar: ¿Qué formas para crear conocimiento en las humanidades digitales (en sentido amplio) surgen ante los desafíos apremiantes en las Américas? ¿Cómo responden los humanistas digitales a las emergencias mediante la creación de conocimiento, teniendo en cuenta las ramificaciones de la informática en las crisis ambientales? ¿Qué perspectivas revelan los temas de transnacionalismo y solidaridad en las Américas sobre nuestro trabajo y nuestras comunidades, y el papel de las tecnologías emergentes en la conformación de ambos?
...
* Aprendizaje automático, incluyendo IA y LLM y sus implicaciones   
...
Presentaciones creativas (3-5 minutos presentación corta y sesión de póster): 
...
Favor incluir la lista de participantes e información de contacto directamente en ConfTool junto con el envío de la propuesta.
...
* Falta de consenso sobre cómo anonimizar las presentaciones, lo que conduce a propuestas que son inadvertidamente identificables;  
* La naturaleza pública de la investigación en las humanidades digitales, lo que significa que, no se garantiza que las presentaciones anónimas sean anónimas; y  
* El relevo deresponsabilidad que surge en la revisión por pares a ciegas que puede promover la falta de civismo en el proceso de revisión.
...
* 20% – Compromiso con Investigaciones Recientes
  ...
  La propuesta se relaciona explícitamente con investigaciones recientes y ofrece un contexto dentro del estado actual de los campos en los que se involucra. Las citas formales (en el estilo preferido del redactor de la propuesta) solo se requieren cuando se utilizan citas directas.

* 20% – Marco Teórico y Propósito
...
Los evaluadores sólo podrán ver las propuestas que les hayan sido asignadas para su revisión. Los autores podrán ver las revisiones de sus envíos una vez concluya el proceso de revisión. Los nombres de los evaluadores se mostrarán en una diapositiva en orden alfabético durante la sesión de apertura de la conferencia en agradecimiento por su contribución.
...
Miembro de ACH: $55  
Estudiante miembro de ACH: $25  
No miembro regular: $95  
...
Líder de promoción y patrocinadores: Stefano Morello (City University of New York’s Graduate Center)

Líder de grupos regionales: Jennifer Ross (Universidad de Toronto) 

Líder de comunicaciones: Amanda Reagan (Universidad de Clemson)
